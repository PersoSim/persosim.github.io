...
* In der Oberfläche der AusweisApp2 klicken Sie bitte zehnmal auf die Versionsnummer. Danach gelangen Sie in den Entwicklermodus. Im Entwicklermodus können Sie dann unter Einstellungen|Entwicklermodus den Testmodus für die Selbstauskunft aktivieren.
